...
const en = {
  ...
  'board.quota.ready': 'Next turn ready',
  'board.quota.waiting': 'Waiting quota',
  'board.quota.user': 'Waiting on you',
  'board.status.needs_you': 'Needs you',
  'board.status.active': 'In progress',
  ...
  'board.goal.id': 'Goal {goalId}',
  'board.meta.lanes': '{count} workers',
  'board.meta.chats': '{count} chats',
  'board.task.gate': 'Needs you',
  'board.task.monitor': 'Watching',
  'board.task.blocked': 'Blocked',
  'board.group.gate': 'Needs you',
  'board.group.in_progress': 'In progress',
  'board.group.waiting': 'Waiting',
  'board.group.scheduled': 'Watching',
  'board.add.label': 'New task',
  'board.add.placeholder': 'Add a task to this Goal…',
  'board.add': 'Add',
  'board.complete': 'Done',
  'board.resolve': 'Resolve',
...
const zh: Record<GoalBarLocaleKey, string> = {
  ...
  'board.quota.ready': '下一轮可续跑',
  'board.quota.waiting': '等待配额',
  'board.quota.user': '等待你处理',
  'board.status.needs_you': '需要你处理',
  'board.status.active': '进行中',
  'board.status.done': '已完成',
  'board.status.paused': '已暂停',
  ...
  'board.goal.id': '目标 {goalId}',
  'board.meta.lanes': '{count} 个工人',
  'board.meta.chats': '{count} 个对话',
  'board.task.gate': '需要你',
  'board.task.monitor': '观察',
  'board.task.blocked': '阻塞',
  'board.group.gate': '需要你',
  'board.group.in_progress': '进行中',
  'board.group.waiting': '等待中',
  'board.group.scheduled': '持续观察',
  'board.add.label': '新任务',
  'board.add.placeholder': '给这个目标加一个任务…',
  'board.add': '添加',
  'board.complete': '完成',
  'board.resolve': '处理',
