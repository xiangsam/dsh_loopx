...
const en = {
  ...
  'board.workspace.body': 'This Goal belongs to the project. This chat is watching. Run /loopx here to drive in this Session, or leave if you were bound by mistake.',
...
const zh: Record<GoalBarLocaleKey, string> = {
  ...
  'board.workspace.body': '目标挂在项目上，当前对话只是旁观。在本会话运行 /loopx 才会在这里推进；若是误绑定，可以离开此对话。',
